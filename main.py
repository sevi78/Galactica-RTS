...
class GameLogic:
    ...
    def add_object(self):
        ...
        size = 30
        spacing = 10
        for key, value  in images[pictures_path]["celestial objects"].items():
...
class App(AppHelper, UIBuilder, GameLogic):
    def __init__(self, width, height):
        ...
        # set app-icon
        pygame.display.set_icon(images[pictures_path]["planets"]["Zeta Bentauri_60x60.png"])
    ...
    def update(self, events):
        ...
        # set fps
        self.clock.tick(fps)
        pygame.display.set_caption(root + "   " + str(f"FPS: {self.clock.get_fps()}"))
        ...
        drawText(self.win, self.event_display_text,colors.frame_color,
