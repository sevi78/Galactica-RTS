...
class BuildingPanel(WidgetBase):
    ...
    def __init__(self, win, x, y, width, height, isSubWidget=False, **kwargs):
        ...
        self.minus_arrow_button = Button(win=self.win,
                                 ...
                                 height=self.image_size[1],
                                 isSubWidget=False,
                                 image=pygame.transform.scale (source.Globals.images[pictures_path]["icons"]["arrow-left.png"],(self.arrow_size,self.arrow_size)),
        ...
        self.spacehunter_icon = ImageButton(win=self.win,
            ...
            isSubWidget=False,
            parent=self,
            image=pygame.transform.scale (source.Globals.images[pictures_path]["ships"]["spacehunter_30x30.png"], (25, 25)),
        ...
        self.planet_editor_icon = ImageButton(win=self.win,
            ...
            isSubWidget=False,
            parent=self,
            image=pygame.transform.scale(source.Globals.images[pictures_path]["planets"]["Zeta Bentauri_60x60.png"], (25, 25)),
        ...
        self.building_editor_icon = ImageButton(win=self.win,
            ...
            moveable=False,
            include_text=True, layer=self.layer,
            onClick=lambda: source.BuildingEditor.main(surface= self.win))#self.set_global_variable("building_editor_draw", True))
    ...
    def listen(self, events):
        #print (self.singleton_buildings)
        for event in events:
        ...
        for building_name, image_rect in self.singleton_buildings_images.items():
            ...
            if image_rect.collidepoint(pygame.mouse.get_pos()):
                self.hover = True
                source.Globals.tooltip_text = f"are you shure you want destroy this {building_name} ?! ... you will probably not getting anything back !"
            elif self.hover:
                self.hover = False
                source.Globals.tooltip_text = ""
        #print ("buidliong_panel.listen", self.singleton_buildings_images)
    ...
    def destroy_building(self, b):
        ...
        source.Sounds.sounds.play_sound(source.Sounds.sounds.destroy_building)
    ...
    def update(self):
        """
        updates all values to display and sets its size dynamically
        :return:
        """
        pass
    ...
    def draw(self):
        ...
        self.win.blit(self.year_text,
            (self.surface_rect.x + self.spacing_x + self.spacing_x,
             self.clock_icon._y + self.clock_icon.getHeight() - self.year_text.get_height()))
        ...
        if self.parent.selected_planet:
            ...
            # image = pygame.transform.scale (source.Globals.images[pictures_path]["buildings"]["city_25x25.png"],
            ...
            for b in self.singleton_buildings:
                #self.singleton_buildings_pos[b] = ((x, self.y + y),self.resource_image_size)
                # building_button = ImageButton(
                #     self.win,x,self.y + y, self.resource_image_size[0], self.resource_image_size[1],
                #     isSubWidget=False,
                #     image=pygame.transform.scale( source.Globals.images[pictures_path]["buildings"][b + "_25x25.png"], self.resource_image_size),
                #     onClick=lambda: self.destroy_building(b))
            ...
            # GLOBAL PRODUCTION
            # y = self.planet_surface_rect.y + self.spacing * 25
