...
class SceneBuilder(SceneParams):
    ...
    def create_artefacts(self):  # self not working yet
        w = source.scene_width
        h = source.scene_height
        buffer = 100

        images = {0:source.Globals.images[pictures_path]["artefacts"]["artefact1_60x31.png"],
                  1:source.Globals.images[pictures_path]["celestial objects"]["meteor_50x50.png"],
                  2:source.Globals.images[pictures_path]["celestial objects"]["meteor_60x83.png"],
                  3:source.Globals.images[pictures_path]["celestial objects"]["meteor1_50x50.png"]}
