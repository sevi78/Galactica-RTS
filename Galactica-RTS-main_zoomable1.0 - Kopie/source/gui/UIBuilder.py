...
class UIBuilder(SceneBuilder):
    ...
    def __init__(self, width, height):
        ...
        self.navigation = Navigation(source.utils.Globals.win, 0, 0, width, height, isSubWidget=False, scene_width=source.utils.Globals.scene_width, scene_height=source.utils.Globals.scene_height,
