...
class FogOfWar(WidgetBase, Moveable):
    ...
    def draw_fog_of_war(self, obj, **kwargs):
        ...
        :return:
        """
        if source.utils.Globals.app == None:  # bullshit here, bad initializing
            return
        ...
        x = x - source.utils.Globals.app.fog_of_war.getX()
        y = y - source.utils.Globals.app.fog_of_war.getY()
