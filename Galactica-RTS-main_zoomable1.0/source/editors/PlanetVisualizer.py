...
def main(test: bool = False, **kwargs) -> None:
    ...
    # global sound
    # global surface
    surface = utils.Globals.win  # create_example_window('Galactica - Settings', WINDOW_SIZE,init_pygame=False)#kwargs.get("surface") #
    ...
    planet = utils.Globals.app.selected_planet
    if not planet:
        return
    elif planet:
