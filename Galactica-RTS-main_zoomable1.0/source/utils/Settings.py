...
from source.utils.saveload import load_file, write_file
...
def main(test: bool = False, **kwargs) -> None:
    ...
    # Create window
    # -------------------------------------------------------------------------
    surface = source.utils.Globals.win  # create_example_window('Galactica - Settings', WINDOW_SIZE,init_pygame=False)#kwargs.get("surface") #
    ...
    def data_fun() -> None:
        ...
        source.utils.Globals.settings = data
        ...
        for key,  value in data.items():
            ...
            if hasattr(utils.Globals, key):
                setattr(utils.Globals, key, value)
